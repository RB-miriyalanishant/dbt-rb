{{  config(
        ...
        covenant_type_id_sequence START {{get_table_maxid('edw','dim_covenant_type','wh_covenant_type_id')}} INCREMENT 1;"]
    ) 
}}
...
WITH
    dim_covenant_type AS (
        SELECT
            covenant_type_id_sequence.nextval AS wh_covenant_type_id,
